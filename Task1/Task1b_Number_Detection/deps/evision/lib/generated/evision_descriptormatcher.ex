defmodule Evision.DescriptorMatcher do
  ...
  @typedoc """
  Type that represents an `Evision.DescriptorMatcher` struct.
  ...
  @doc false
  def __to_struct__({:ok, %{class: :DescriptorMatcher, ref: ref}}) do
    {:ok, %T{ref: ref}}
  end

  def __to_struct__(%{class: :DescriptorMatcher, ref: ref}) do
    %T{
      ref: ref
    }
  end
  ...
  """
  @spec add(Evision.DescriptorMatcher.t(), list(Evision.Mat.maybe_mat_in())) :: :ok | {:error, String.t()}
  ...
  """
  @spec clear(Evision.DescriptorMatcher.t()) :: :ok | {:error, String.t()}
  def clear(self) do
    positional = [
    ]
  ...
  """
  @spec knnMatch(Evision.DescriptorMatcher.t(), Evision.Mat.maybe_mat_in(), Evision.Mat.maybe_mat_in(), integer(), [{atom(), term()},...] | nil) :: list(list(Evision.DMatch.t())) | {:error, String.t()}
  ...
  """
  @spec knnMatch(Evision.DescriptorMatcher.t(), Evision.Mat.maybe_mat_in(), integer(), [{atom(), term()},...] | nil) :: list(list(Evision.DMatch.t())) | {:error, String.t()}
  ...
  """
  @spec match(Evision.DescriptorMatcher.t(), Evision.Mat.maybe_mat_in(), Evision.Mat.maybe_mat_in(), [{atom(), term()},...] | nil) :: list(Evision.DMatch.t()) | {:error, String.t()}
  ...
  """
  @spec match(Evision.DescriptorMatcher.t(), Evision.Mat.maybe_mat_in(), [{atom(), term()},...] | nil) :: list(Evision.DMatch.t()) | {:error, String.t()}
  ...
  """
  @spec radiusMatch(Evision.DescriptorMatcher.t(), Evision.Mat.maybe_mat_in(), Evision.Mat.maybe_mat_in(), number(), [{atom(), term()},...] | nil) :: list(list(Evision.DMatch.t())) | {:error, String.t()}
  ...
  """
  @spec radiusMatch(Evision.DescriptorMatcher.t(), Evision.Mat.maybe_mat_in(), number(), [{atom(), term()},...] | nil) :: list(list(Evision.DMatch.t())) | {:error, String.t()}
  ...
  """
  @spec read(Evision.DescriptorMatcher.t(), Evision.FileNode.t()) :: :ok | {:error, String.t()}
  ...
  @spec read(Evision.DescriptorMatcher.t(), binary()) :: :ok | {:error, String.t()}
  ...
  """
  @spec train(Evision.DescriptorMatcher.t()) :: :ok | {:error, String.t()}
  def train(self) do
    positional = [
    ]
  ...
  """
  @spec write(Evision.DescriptorMatcher.t(), Evision.FileStorage.t(), [{atom(), term()},...] | nil) :: :ok | {:error, String.t()}
  def write(self, fs, opts) when is_struct(fs, Evision.FileStorage) and (opts == nil or (is_list(opts) and is_tuple(hd(opts))))
  do
    positional = [
      fs: Evision.Internal.Structurise.from_struct(fs)
    ]
    :evision_nif.descriptorMatcher_write(Evision.Internal.Structurise.from_struct(self), positional ++ Evision.Internal.Structurise.from_struct(opts || []))
     |> __to_struct__()
  end
  ...
  """
  @spec write(Evision.DescriptorMatcher.t(), Evision.FileStorage.t()) :: :ok | {:error, String.t()}
  ...
  @spec write(Evision.DescriptorMatcher.t(), binary()) :: :ok | {:error, String.t()}
