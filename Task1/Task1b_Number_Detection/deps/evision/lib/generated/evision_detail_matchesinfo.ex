defmodule Evision.Detail.MatchesInfo do
  ...
  @typedoc """
  Type that represents an `Evision.Detail.MatchesInfo` struct.
  ...
  @doc false
  def __to_struct__({:ok, %{class: :"Detail.MatchesInfo", ref: ref}}) do
    {:ok, %T{ref: ref}}
  end

  def __to_struct__(%{class: :"Detail.MatchesInfo", ref: ref}) do
    %T{
      ref: ref
    }
  end
  ...
  def set_H(self, prop) do
    :evision_nif.detail_MatchesInfo_set_H(Evision.Internal.Structurise.from_struct(self), [H: Evision.Internal.Structurise.from_struct(prop)])
    |> __to_struct__()
  end
  ...
  def set_confidence(self, prop) do
    :evision_nif.detail_MatchesInfo_set_confidence(Evision.Internal.Structurise.from_struct(self), [confidence: Evision.Internal.Structurise.from_struct(prop)])
    |> __to_struct__()
  end
  ...
  def set_dst_img_idx(self, prop) do
    :evision_nif.detail_MatchesInfo_set_dst_img_idx(Evision.Internal.Structurise.from_struct(self), [dst_img_idx: Evision.Internal.Structurise.from_struct(prop)])
    |> __to_struct__()
  end
  ...
  def set_inliers_mask(self, prop) do
    :evision_nif.detail_MatchesInfo_set_inliers_mask(Evision.Internal.Structurise.from_struct(self), [inliers_mask: Evision.Internal.Structurise.from_struct(prop)])
    |> __to_struct__()
  end
  ...
  def set_matches(self, prop) do
    :evision_nif.detail_MatchesInfo_set_matches(Evision.Internal.Structurise.from_struct(self), [matches: Evision.Internal.Structurise.from_struct(prop)])
    |> __to_struct__()
  end
  ...
  def set_num_inliers(self, prop) do
    :evision_nif.detail_MatchesInfo_set_num_inliers(Evision.Internal.Structurise.from_struct(self), [num_inliers: Evision.Internal.Structurise.from_struct(prop)])
    |> __to_struct__()
  end
  ...
  def set_src_img_idx(self, prop) do
    :evision_nif.detail_MatchesInfo_set_src_img_idx(Evision.Internal.Structurise.from_struct(self), [src_img_idx: Evision.Internal.Structurise.from_struct(prop)])
    |> __to_struct__()
  end
end
