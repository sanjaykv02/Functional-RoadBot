defmodule Evision.FastFeatureDetector do
  ...
  @typedoc """
  Type that represents an `Evision.FastFeatureDetector` struct.
  ...
  @doc false
  def __to_struct__({:ok, %{class: :FastFeatureDetector, ref: ref}}) do
    {:ok, %T{ref: ref}}
  end

  def __to_struct__(%{class: :FastFeatureDetector, ref: ref}) do
    %T{
      ref: ref
    }
  end
  ...
  ##### Return
  - **retval**: `Evision.FastFeatureDetector`
  ...
  """
  @spec create([{atom(), term()},...] | nil) :: Evision.FastFeatureDetector.t() | {:error, String.t()}
  ...
  """
  @spec detect(Evision.FastFeatureDetector.t(), list(Evision.Mat.maybe_mat_in()), [{atom(), term()},...] | nil) :: list(list(Evision.KeyPoint.t())) | {:error, String.t()}
  ...
  @spec detect(Evision.FastFeatureDetector.t(), Evision.Mat.maybe_mat_in(), [{atom(), term()},...] | nil) :: list(Evision.KeyPoint.t()) | {:error, String.t()}
  ...
  """
  @spec detectAndCompute(Evision.FastFeatureDetector.t(), Evision.Mat.maybe_mat_in(), Evision.Mat.maybe_mat_in(), [{atom(), term()},...] | nil) :: {list(Evision.KeyPoint.t()), Evision.Mat.t()} | {:error, String.t()}
  ...
  """
  @spec getType(Evision.FastFeatureDetector.t()) :: integer() | {:error, String.t()}
  def getType(self) do
    positional = [
    ]
  ...
  """
  @spec read(Evision.FastFeatureDetector.t(), Evision.FileNode.t()) :: :ok | {:error, String.t()}
  ...
  @spec read(Evision.FastFeatureDetector.t(), binary()) :: :ok | {:error, String.t()}
  ...
  """
  @spec setNonmaxSuppression(Evision.FastFeatureDetector.t(), boolean()) :: :ok | {:error, String.t()}
  ...
  """
  @spec setThreshold(Evision.FastFeatureDetector.t(), integer()) :: :ok | {:error, String.t()}
  ...
  """
  @spec setType(Evision.FastFeatureDetector.t(), integer()) :: :ok | {:error, String.t()}
  ...
  """
  @spec write(Evision.FastFeatureDetector.t(), Evision.FileStorage.t(), [{atom(), term()},...] | nil) :: :ok | {:error, String.t()}
  def write(self, fs, opts) when is_struct(fs, Evision.FileStorage) and (opts == nil or (is_list(opts) and is_tuple(hd(opts))))
  do
    positional = [
      fs: Evision.Internal.Structurise.from_struct(fs)
    ]
    :evision_nif.fastFeatureDetector_write(Evision.Internal.Structurise.from_struct(self), positional ++ Evision.Internal.Structurise.from_struct(opts || []))
     |> __to_struct__()
  end
  ...
  """
  @spec write(Evision.FastFeatureDetector.t(), Evision.FileStorage.t()) :: :ok | {:error, String.t()}
  ...
  @spec write(Evision.FastFeatureDetector.t(), binary()) :: :ok | {:error, String.t()}
