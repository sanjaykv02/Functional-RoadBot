defmodule Evision.Samples do
  ...
  @typedoc """
  Type that represents an `Evision.Samples` struct.
  ...
  @doc false
  def __to_struct__({:ok, %{class: :Samples, ref: ref}}) do
    {:ok, %T{ref: ref}}
  end

  def __to_struct__(%{class: :Samples, ref: ref}) do
    %T{
      ref: ref
    }
  end
  ...
  """
  @spec findFile(binary(), [{atom(), term()},...] | nil) :: binary() | {:error, String.t()}
  ...
  """
  @spec findFileOrKeep(binary(), [{atom(), term()},...] | nil) :: binary() | {:error, String.t()}
