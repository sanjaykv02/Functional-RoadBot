defmodule Evision.Detail.VoronoiSeamFinder do
  ...
  @typedoc """
  Type that represents an `Evision.Detail.VoronoiSeamFinder` struct.
  ...
  @doc false
  def __to_struct__({:ok, %{class: :"Detail.VoronoiSeamFinder", ref: ref}}) do
    {:ok, %T{ref: ref}}
  end

  def __to_struct__(%{class: :"Detail.VoronoiSeamFinder", ref: ref}) do
    %T{
      ref: ref
    }
  end
